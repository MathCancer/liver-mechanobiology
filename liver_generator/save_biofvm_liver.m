...
% dist_tncv = distance_to_nearest_central_vein;
% save dist_tncv.mat dist_tncv -v4   % For names exceeding 19 characters use MAT-file version 6 or later % -v7.3 -nocompression
